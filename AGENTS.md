...
> `tradingview_mcp/AGENTS.md` 를 이 프로젝트 구조에 맞게 옮긴 버전.  
> 새 전략 전용 체크리스트·폴더 규칙은 **`.Codex/QUANT_STRATEGIES.md`** 참고.
...
- **`.Codex/QUANT_STRATEGIES.md`** — 새 quant 전략 추가 시 폴더·네이밍·등록 절차
...
- `AGENTS.md` / `.Codex/QUANT_STRATEGIES.md` 는 `tradingview_mcp/AGENTS.md` 기준으로 btc에 맞게 재작성.
