"""OI Accel Breakout v2 — Forward Test Engine (BaseForwardTest tick)."""
...
class OiAccelBreakoutV2ForwardTest(BaseForwardTest):
    STRATEGY_TAG = "oi_accel_breakout_v2"
    ...
    def tick(
        ...
        entry_tf = state.get("entry_tf") or "15m"
        ...
        if self._position is None and not just_closed:
            ...
            if direction in ("long", "short") and tp > 0 and sl > 0:
                pos: Dict[str, Any] = {
                    ...
                    "oi_accel_z":  sig.get("oi_accel_z"),
                    "cvd_pct":     sig.get("cvd_pct"),
...
get_engine = _make_engine(OiAccelBreakoutV2ForwardTest)
